...
export default function GeneralCategory() {
    return (
        <article className="flex flex-col gap-y-8 px-32 pt-10 pb-32">
            ...
            <DiscordSection>
                <DiscordMessage msg={""} size={700} isBot={true} imagen={"/src/assets/commands/report-example-1.png"} imagenHeight={265} imagenWidth={540}></DiscordMessage>
                <DiscordMessage msg={""} size={700} isBot={true} imagen={"/src/assets/commands/report-example-2.png"} imagenHeight={285} imagenWidth={550}></DiscordMessage>
            </DiscordSection>
        </article>
    )
}