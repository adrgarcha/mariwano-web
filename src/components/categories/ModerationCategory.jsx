  ...
  return (
    <article className="flex flex-col gap-y-8 px-32 pt-10 pb-32">
      ...
      <CategorySection command={"ban"} params={"target-user, reason"} >
        Banea a el usuario introducido en <i>target-user</i> con la opción de dar una razón en la casilla de <i>reason</i>.
        El usuario no podrá volver a entrar hasta que un administrador le desbanee.
      </CategorySection>
      <DiscordSection>
      ...
      <CategorySection command={"kick"} params={"target-user, reason"} >
        Expulsa del servidor al usuario introducido en <i>target-user</i> con la opción de dar una razón en la casilla de <i>reason</i>.
        El usuario podrá ser invitado de vuelta al servidor.
      </CategorySection>
      <DiscordSection>
      ...
      <CategorySection command={"timeout"} params={"target-user, duration, reason"} >
        Banea a un usuario por un determinado tiempo puesto en <i>duration</i>.
        En dicho parámetro se debe introducir la cantidad de tiempo junto la primera letra de la unidad de tiempo, por ejemplo <i>15m</i> resultaría en un baneo de 15 minutos.
      </CategorySection>
      <DiscordSection>
